package kso.android.todoapp.ui
...
fun NetworkAlertScreen(connectionMessage: String) {
    Box(
        ...
        Row(
            ...
            Text(text = connectionMessage, fontWeight = FontWeight.SemiBold, color = MaterialTheme.colors.primary, fontSize = 12.sp, modifier = Modifier.padding(10.dp))
